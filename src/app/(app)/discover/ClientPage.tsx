...
export default function DiscoverPage() {
  ...
  const { data: suggestedFood, isLoading: suggestedLoading } = useProductCategory("drinks");
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-5 lg:px-8 max-w-screen-xl mx-auto">
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-3">
            {foodsLoading
              ...
              : displayFoods.slice(0, 5).map((food: any) => <FoodCard key={food._id} food={food} />)}
          </div>
        ...
        {/* Drinks list/grid */}
        {suggestedFood && suggestedFood.length > 0 &&
          <section className="mb-10">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-bold text-gray-900">
                Drinks
            ...
            <FeaturedCarousel foods={suggestedFood?.slice(0, 3) || []} loading={suggestedLoading} />
          </section>
        }
      </div>
